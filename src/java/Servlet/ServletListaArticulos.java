 ...
 * @author JuanMi
 */
@WebServlet(urlPatterns = {"/ServletListaArticulos"})
public class ServletListaArticulos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            cConsulta = "SELECT * from articulos";
            ...
            while( rInf.next() ){
                ...
                oArticulo.setTitulo(rInf.getString("titulo") );
                ...
                oArticulo.setCantidad(rInf.getInt("cantidad") );
            ...
            response.sendRedirect("Lista_Articulos.jsp");
