    ...
    //  Fecha del dia
        ...
        //  Actualizar stock del articulo.    
            ...
            while(itListaCesta.hasNext()){
                ...
                st.setInt(1,cesta_tmp.getUnd_cesta());
        ...
        //  Insertar lineas en tabla de ventas.
            cInsert = "insert into ventas (id_venta, id_linea, id_cliente_vt, id_art_vt, fecha_vt, precio_art, und_venta) "+
                      " VALUES (?,?,?,?,?,?,?)";
            ...
            while(itListaCesta2.hasNext()){
                ...
                if (cesta_tmp2.getUnd_cesta() > 0 ){  // Si la linea tiene unidades, se graba.
                    nLinea++;
                    st.setInt(1,nVenta);
                    st.setInt(2,nLinea);
                    ...
                    st.setInt(7,cesta_tmp2.getUnd_cesta());
                    st.executeUpdate();
                } // Fin  if (cesta_tmp2.getUnd_cesta() > 0 )
                
            }  // Fin while(itListaCesta2.hasNext())  
        ...
        //  Actualizar Nº de compras del cliente/usuario.    
            cUpdate = "UPDATE usuarios SET compras = compras + 1 WHERE id_user = ?";
