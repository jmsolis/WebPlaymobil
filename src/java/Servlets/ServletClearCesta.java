...
public class ServletClearCesta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            oBD.desconectar(); 
            if (nRetorno > 0) {
                JOptionPane.showMessageDialog(null,"Cesta del usuario [ "+cUsr+" - "+cNom+" ] ¡¡BORRADA!! [ "+nRetorno+" articulos ].");
                }else{
                    JOptionPane.showMessageDialog(null,"La Cesta del usuario [ "+cUsr+" - "+cNom+" ], no contiene datos.");
                }
