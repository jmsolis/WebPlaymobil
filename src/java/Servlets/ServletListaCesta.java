...
public class ServletListaCesta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            cConsulta = "SELECT ces.id_cliente, nombre, id_art, descripcion, foto, und_cesta, "+
                        "precio_cesta, (precio_cesta * und_cesta) AS total_linea " +
                        "from cesta ces " +
            ...
            while( rInf.next() ){
                ...
                oCesta.setUnd_cesta(rInf.getInt("und_cesta") );
            ...
            response.sendRedirect("ComprarArticulo.jsp");
