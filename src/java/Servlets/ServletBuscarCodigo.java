 ...
 * @author JuanMi
 */
@WebServlet(urlPatterns = {"/ServletBuscarCodigo"})
public class ServletBuscarCodigo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            int nCodigo = Integer.parseInt(request.getParameter("codigo"));
            request.getSession().setAttribute("nCodigo", nCodigo);
            String cConsulta;
            ...
            cConsulta = "SELECT * from articulos where id_art = ?";
